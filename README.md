...
```bash
curl -LO https://dlcdn.apache.org/spark/spark-4.2.0/spark-4.2.0-bin-hadoop3-connect.tgz && tar xvf spark-4.2.0-bin-hadoop3-connect.tgz
```
...
```
export SPARK_HOME=<path-to>/spark-4.2.0-bin-hadoop3-connect
